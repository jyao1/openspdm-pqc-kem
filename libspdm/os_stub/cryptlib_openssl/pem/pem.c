  ...
  )
{
  ...
  //
  *rsa_context = PEM_read_bio_RSAPrivateKey (pem_bio, NULL, (pem_password_cb *) &PasswordCallback, (void *) password);
  if (*rsa_context != NULL) {
    status = TRUE;
  }
  ...
  )
{
  ...
  //
  *ec_context = PEM_read_bio_ECPrivateKey (pem_bio, NULL, (pem_password_cb *) &PasswordCallback, (void *) password);
  if (*ec_context != NULL) {
    status = TRUE;
  }
