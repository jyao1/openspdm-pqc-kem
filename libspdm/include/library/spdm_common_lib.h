...
typedef enum {
  ...
  SPDM_DATA_PQC_KEM_AUTH_ALGO,
  SPDM_DATA_PQC_REQ_KEM_AUTH_ALGO,
  ...
  SPDM_DATA_PQC_LOCAL_KEM_AUTH_PUBLIC_KEY,
  SPDM_DATA_PQC_PEER_KEM_AUTH_PUBLIC_KEY,
...
**/
void *
spdm_get_session_info_via_session_id (
  IN     void                      *spdm_context,
  IN     uint32                    session_id
  );
...
**/
void *
spdm_get_secured_message_context_via_session_info (
  IN     void                      *spdm_session_info
  );
...
typedef enum {
  ...
  PERF_ID_CHALLENG_KEM_AUTH_ENCAP,
  PERF_ID_CHALLENG_KEM_AUTH_DECAP,
  PERF_ID_KEY_EX_KEM_GEN,
  PERF_ID_KEY_EX_KEM_ENCAP,
  PERF_ID_KEY_EX_KEM_DECAP,
  PERF_ID_KEY_EX_SIG_GEN,
  PERF_ID_KEY_EX_SIG_VER,
  PERF_ID_KEY_EX_KEM_AUTH_ENCAP,
  PERF_ID_KEY_EX_KEM_AUTH_DECAP,
  PERF_ID_CHALLENG_RSP_SIG_GEN,
  PERF_ID_CHALLENG_RSP_SIG_VER,
  PERF_ID_CHALLENG_RSP_KEM_AUTH_ENCAP,
  PERF_ID_CHALLENG_RSP_KEM_AUTH_DECAP,
  PERF_ID_FINISH_REQ_SIG_GEN,
  PERF_ID_FINISH_REQ_SIG_VER,
  PERF_ID_KEY_EX_REQ_KEM_AUTH_ENCAP,
  PERF_ID_KEY_EX_REQ_KEM_AUTH_DECAP,
  PERF_ID_MAX,
} perf_id_t;
