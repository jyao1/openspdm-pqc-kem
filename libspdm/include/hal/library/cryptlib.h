...
**/
boolean
hmac_sha384_duplicate (
  IN   const void  *hmac_sha384_ctx,
...
**/
boolean
hmac_sha512_duplicate (
  IN   const void  *hmac_sha512_ctx,
...
boolean
rsa_set_key (
  IN OUT  void         *rsa_context,
  IN      rsa_key_tag_t  key_tag,
  IN      const uint8  *big_number,
  IN      uintn        bn_size
  );
...
rsa_get_key (
  IN OUT  void         *rsa_context,
  IN      rsa_key_tag_t  key_tag,
  OUT     uint8        *big_number,
  IN OUT  uintn        *bn_size
  );
...
**/
boolean
dh_generate_parameter (
  IN OUT  void   *dh_context,
  IN      uintn  generator,
  IN      uintn  prime_length,
  OUT     uint8  *prime
  );
