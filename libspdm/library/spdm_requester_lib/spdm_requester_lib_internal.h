...
**/
return_status
spdm_handle_simple_error_response (
  IN     void                 *context,
  IN     uint8                error_code
  );
...
**/
return_status
spdm_get_encap_response_digest (
  IN     void                 *context,
...
**/
return_status
spdm_get_encap_response_key_update (
  IN     void                 *context,
  IN     uintn                request_size,
  IN     void                 *request,
  IN OUT uintn                *response_size,
