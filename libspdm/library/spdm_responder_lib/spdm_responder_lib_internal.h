...
**/
return_status
spdm_responder_handle_response_state (
  IN     void                 *spdm_context,
...
**/
return_status
spdm_get_response_respond_if_ready (
  IN     void                 *spdm_context,
  IN     uintn                request_size,
  IN     void                 *request,
  IN OUT uintn                *response_size,
...
**/
return_status
spdm_get_response_capabilities (
  IN     void                 *spdm_context,
  IN     uintn                request_size,
  IN     void                 *request,
  IN OUT uintn                *response_size,
...
**/
return_status
spdm_get_response_psk_exchange (
  IN     void                 *spdm_context,
  IN     uintn                request_size,
  IN     void                 *request,
  IN OUT uintn                *response_size,
...
**/
return_status
spdm_get_encap_request_get_digest (
...
**/
return_status
spdm_get_encap_request_key_update (
  IN     spdm_context_t  *spdm_context,
  IN OUT uintn                *encap_request_size,
     OUT void                 *encap_request
  );
...
**/
return_status
spdm_handle_encap_error_response_main (
  IN     spdm_context_t  *spdm_context,
  IN OUT void                 *m_buffer,
  IN     uintn                shrink_buffer_size,
  IN     uint8                error_code
  );
