...
typedef struct {
  UINT8                AlgType;
  UINT8                AlgCount;
  PQC_ALGO             AlgSupported;
} SPDM_NEGOTIATE_ALGORITHMS_COMMON_STRUCT_PQC_TABLE;
...
// RAINBOW
#define SPDM_ALGORITHMS_PQC_DIGITAL_SIGNATURE_ALGO_RAINBOW_INDEX_BEGIN 2
#define SPDM_ALGORITHMS_PQC_DIGITAL_SIGNATURE_ALGO_RAINBOW_INDEX_END   3
#define SPDM_ALGORITHMS_PQC_DIGITAL_SIGNATURE_ALGO_RAINBOW_I_CLASSIC            BIT0
#define SPDM_ALGORITHMS_PQC_DIGITAL_SIGNATURE_ALGO_RAINBOW_I_CIRCUMZENITHAL     BIT1
#define SPDM_ALGORITHMS_PQC_DIGITAL_SIGNATURE_ALGO_RAINBOW_I_COMPRESSED         BIT2
#define SPDM_ALGORITHMS_PQC_DIGITAL_SIGNATURE_ALGO_RAINBOW_III_CLASSIC          BIT3
#define SPDM_ALGORITHMS_PQC_DIGITAL_SIGNATURE_ALGO_RAINBOW_III_CIRCUMZENITHAL   BIT4
#define SPDM_ALGORITHMS_PQC_DIGITAL_SIGNATURE_ALGO_RAINBOW_III_COMPRESSED       BIT5
#define SPDM_ALGORITHMS_PQC_DIGITAL_SIGNATURE_ALGO_RAINBOW_V_CLASSIC            BIT6
#define SPDM_ALGORITHMS_PQC_DIGITAL_SIGNATURE_ALGO_RAINBOW_V_CIRCUMZENITHAL     BIT7
#define SPDM_ALGORITHMS_PQC_DIGITAL_SIGNATURE_ALGO_RAINBOW_V_COMPRESSED         BIT8
...
// PICNIC
#define SPDM_ALGORITHMS_PQC_DIGITAL_SIGNATURE_ALGO_PICNIC_INDEX_BEGIN 9
#define SPDM_ALGORITHMS_PQC_DIGITAL_SIGNATURE_ALGO_PICNIC_INDEX_END   10
#define SPDM_ALGORITHMS_PQC_DIGITAL_SIGNATURE_ALGO_PICNIC_L1_FS                 BIT0
#define SPDM_ALGORITHMS_PQC_DIGITAL_SIGNATURE_ALGO_PICNIC_L1_UR                 BIT1
#define SPDM_ALGORITHMS_PQC_DIGITAL_SIGNATURE_ALGO_PICNIC_L1_FULL               BIT2
#define SPDM_ALGORITHMS_PQC_DIGITAL_SIGNATURE_ALGO_PICNIC_L3_FS                 BIT3
#define SPDM_ALGORITHMS_PQC_DIGITAL_SIGNATURE_ALGO_PICNIC_L3_UR                 BIT4
#define SPDM_ALGORITHMS_PQC_DIGITAL_SIGNATURE_ALGO_PICNIC_L3_FULL               BIT5
#define SPDM_ALGORITHMS_PQC_DIGITAL_SIGNATURE_ALGO_PICNIC_L5_FS                 BIT6
#define SPDM_ALGORITHMS_PQC_DIGITAL_SIGNATURE_ALGO_PICNIC_L5_UR                 BIT7
#define SPDM_ALGORITHMS_PQC_DIGITAL_SIGNATURE_ALGO_PICNIC_L5_FULL               BIT8
#define SPDM_ALGORITHMS_PQC_DIGITAL_SIGNATURE_ALGO_PICNIC3_L1                   BIT9
#define SPDM_ALGORITHMS_PQC_DIGITAL_SIGNATURE_ALGO_PICNIC3_L3                   BIT10
#define SPDM_ALGORITHMS_PQC_DIGITAL_SIGNATURE_ALGO_PICNIC3_L5                   BIT11
...
// NTRU
#define SPDM_ALGORITHMS_PQC_KEY_ESTABLISHMENT_ALGO_NTRU_INDEX_BEGIN  4
#define SPDM_ALGORITHMS_PQC_KEY_ESTABLISHMENT_ALGO_NTRU_INDEX_END    4
#define SPDM_ALGORITHMS_PQC_KEY_ESTABLISHMENT_ALGO_NTRU_HPS_2048_509             BIT0
#define SPDM_ALGORITHMS_PQC_KEY_ESTABLISHMENT_ALGO_NTRU_HPS_2048_677             BIT1
#define SPDM_ALGORITHMS_PQC_KEY_ESTABLISHMENT_ALGO_NTRU_HPS_2048_821             BIT2
#define SPDM_ALGORITHMS_PQC_KEY_ESTABLISHMENT_ALGO_NTRU_HRSS_701                 BIT3

// NTRUPRIME
#define SPDM_ALGORITHMS_PQC_KEY_ESTABLISHMENT_ALGO_NTRUPRIME_INDEX_BEGIN  5
#define SPDM_ALGORITHMS_PQC_KEY_ESTABLISHMENT_ALGO_NTRUPRIME_INDEX_END    5
#define SPDM_ALGORITHMS_PQC_KEY_ESTABLISHMENT_ALGO_NTRULPR653                     BIT0
#define SPDM_ALGORITHMS_PQC_KEY_ESTABLISHMENT_ALGO_NTRULPR761                     BIT1
#define SPDM_ALGORITHMS_PQC_KEY_ESTABLISHMENT_ALGO_NTRULPR857                     BIT2
#define SPDM_ALGORITHMS_PQC_KEY_ESTABLISHMENT_ALGO_SNTRUP653                      BIT3
#define SPDM_ALGORITHMS_PQC_KEY_ESTABLISHMENT_ALGO_SNTRUP761                      BIT4
#define SPDM_ALGORITHMS_PQC_KEY_ESTABLISHMENT_ALGO_SNTRUP857                      BIT5

// SABER
#define SPDM_ALGORITHMS_PQC_KEY_ESTABLISHMENT_ALGO_SABER_INDEX_BEGIN  6
#define SPDM_ALGORITHMS_PQC_KEY_ESTABLISHMENT_ALGO_SABER_INDEX_END    6
#define SPDM_ALGORITHMS_PQC_KEY_ESTABLISHMENT_ALGO_LIGHTSABER_KEM                 BIT0
#define SPDM_ALGORITHMS_PQC_KEY_ESTABLISHMENT_ALGO_SABER_KEM                      BIT1
#define SPDM_ALGORITHMS_PQC_KEY_ESTABLISHMENT_ALGO_FIRESABER_KEM                  BIT2

// FRODOKEM
#define SPDM_ALGORITHMS_PQC_KEY_ESTABLISHMENT_ALGO_FRODOKEM_INDEX_BEGIN  7
#define SPDM_ALGORITHMS_PQC_KEY_ESTABLISHMENT_ALGO_FRODOKEM_INDEX_END    7
#define SPDM_ALGORITHMS_PQC_KEY_ESTABLISHMENT_ALGO_FRODOKEM_640_AES               BIT0
#define SPDM_ALGORITHMS_PQC_KEY_ESTABLISHMENT_ALGO_FRODOKEM_640_SHAKE             BIT1
#define SPDM_ALGORITHMS_PQC_KEY_ESTABLISHMENT_ALGO_FRODOKEM_976_AES               BIT2
#define SPDM_ALGORITHMS_PQC_KEY_ESTABLISHMENT_ALGO_FRODOKEM_976_SHAKE             BIT3
#define SPDM_ALGORITHMS_PQC_KEY_ESTABLISHMENT_ALGO_FRODOKEM_1344_AES              BIT4
#define SPDM_ALGORITHMS_PQC_KEY_ESTABLISHMENT_ALGO_FRODOKEM_1344_SHAKE            BIT5

// SIKE
#define SPDM_ALGORITHMS_PQC_KEY_ESTABLISHMENT_ALGO_SIKE_INDEX_BEGIN  8
#define SPDM_ALGORITHMS_PQC_KEY_ESTABLISHMENT_ALGO_SIKE_INDEX_END    9
